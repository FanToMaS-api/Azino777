namespace Server.Helpers
{
    ...
    internal static class DefaultText
    {
        ...
        /// </summary>
        public static string SpamWarningText = "Вы слишком часто отправляете сообщения. После нескольких таких предупреждений Ваш аккаунт может быть забанен.";

        /// <summary>
        ///     Предупреждение о использовании собственной реферальной ссылки
        /// </summary>
        public static string SelfReferralErrorText = "Использование собственной реферальной ссылки запрещено правилами.";
    }
}
